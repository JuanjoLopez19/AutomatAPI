...
def create_blueprint(args: dict = None, main_template_path: str = None, endpoint_type:str = None, endpoint_use:str = None) -> None:
    ...
    blueprint_path = add_base_path(DEFAULT_CONFIG['cookiecutter']['aux_stuff']['blueprints'])
...
def create_controllers(controller_args: dict = None, main_template_path: str = None, endpoint_type:str = None, endpoint_use:str = None, strict_mode:str = None) -> None:
    ...
    DEFAULT_CONFIG = get_default_config() # Get the default config
    controller_path = add_base_path(DEFAULT_CONFIG['cookiecutter']['aux_stuff']['controllers']) # Get the path to the template
...
def create_sub_app(subapp_args: dict = None, main_template_path: str = None, type: str = None) -> None:
    ...
    # Get the path to the template
    aux_path = add_base_path(DEFAULT_CONFIG['cookiecutter']['aux_stuff']['sub_app_{}'.format(type)]['template_path'])
